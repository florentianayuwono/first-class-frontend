  ...
  return (
    <div className="bg-light-grey">
      ...
      <div className="absolute z-10 p-10 w-full">
        ...
        <div className="py-4">
          <span className={`${styles.heading4} text-black`}>
...
const OrderComponent = (props) => {
  ...
  return (
    <div
      className="w-100 bg-white flex flex-row rounded-2xl drop-shadow-[0_5px_30px_rgba(0,0,0,0.10)] mb-4"
    ...
    >
      ...
      <div className="w-[60%] flex flex-col justify-center p-4">
        <span className={`${styles.heading4} text-black`}>{order.name}</span>
        <span className={`${styles.paragraph8} text-[#00000050]`}>
          {order.seat}
        </span>
      </div>
    </div>
